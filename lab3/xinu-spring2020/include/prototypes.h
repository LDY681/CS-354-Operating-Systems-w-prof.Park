...
/* in file mymotd.c*/
extern syscall mymotd(void);

/* in file rcreate.c */
extern	pid32	rcreate(void *, uint32, pri16, char *, uint32, ...);

/* in file main.c */
extern	void testBirthNLifeTime(void);
extern	void myTest(char a);
extern	void sndch(char ch);

/* in file getppid.c */
extern pid32 getppid(pid32 pid);

/* in file gettmslice.c */
extern uint32 gettmslice();

/* in file wgetpid.c */
extern pid32 wgetpid();

/* in file wgetprio.c */
extern syscall wgetprio(pid32 proc);

/* in file wgetppid.c */
extern syscall wgetppid(pid32 proc);

/* in file procbirth.c */
extern uint32 procbirth(pid32 proc);

/* in file proclifetime.c */
extern uint32 proclifetime(pid32 proc);

/* in file procgrosscpu.c */
extern uint32 procgrosscpu(pid32 pid);
	
/* in file procgrosscpumicro.c */
extern uint32 procgrosscpumicro(pid32 pid);
	
/* in file rinsert.c */
extern status rinsert(pid32 pid,qid16 q,int32 key);
extern int32 lowestprv();
extern int32 highestprv();
extern void printReadyList(pid32 pid);

/*in file testcpu.c and testio.c*/
extern void testio();
extern void testcpu();
