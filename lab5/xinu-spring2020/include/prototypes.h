...
extern syscall cbunregister(void);
extern void usercb(void);

/* in file main.c */
extern void sleepReceiver(void);	
extern void clkdispReceiver(void);
extern void testSender(pid32 receiver, umsg32 msg);
extern void testGetMemFreeMemKill(void);
/* in file memList.c */
extern void meminsert(struct inusememblk *hdptr, char *memptr);
extern void memextract(struct inusememblk *hdptr, char *memptr);
extern void printMemblkList(bool8 calledByInsert);
